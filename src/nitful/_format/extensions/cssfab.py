...
field_alignment_block = Struct(
    FrameFieldAlignmentBlock,
    [
        FixedFloat("FA_X1", 11, ndigits=7, sign=True),
        FixedFloat("FA_Y1", 11, ndigits=7, sign=True),
        FixedFloat("FA_X2", 11, ndigits=7, sign=True),
        FixedFloat("FA_Y2", 11, ndigits=7, sign=True),
        FixedFloat("FA_X3", 11, ndigits=7, sign=True),
        FixedFloat("FA_Y3", 11, ndigits=7, sign=True),
        FixedFloat("FA_X4", 11, ndigits=7, sign=True),
        FixedFloat("FA_Y4", 11, ndigits=7, sign=True),
    ],
)

fpa_transform = Vector([
    ExpFloat("LS_FID_TRANS_T0", 21, edigits=2),
    ExpFloat("LS_FID_TRANS_T1", 21, edigits=2),
    ExpFloat("LS_FID_TRANS_T2", 21, edigits=2),
    ExpFloat("LS_FID_TRANS_T3", 21, edigits=2),
    ExpFloat("LS_FID_TRANS_T4", 21, edigits=2),
    ExpFloat("LS_FID_TRANS_T5", 21, edigits=2),
    ExpFloat("LS_FID_TRANS_T6", 21, edigits=2),
    ExpFloat("LS_FID_TRANS_T7", 21, edigits=2),
])

telescope_dataset = Struct(
    TelescopeOpticsDataSet,
    [
        FixedFloat("FL_CAL_IOP_TELE", 11, nonnegative, ndigits=8),
        ExpFloat("PPO_XO_TELE", 21, edigits=2),
        ExpFloat("PPO_YO_TELE", 21, edigits=2),
        ExpFloat("RLD_KO_TELE", 21, edigits=2),
        ExpFloat("RLD_K1_TELE", 21, edigits=2),
        ExpFloat("RLD_K2_TELE", 21, edigits=2),
        ExpFloat("RLD_K3_TELE", 21, edigits=2),
        ExpFloat("DCD_P1_TELE", 21, edigits=2),
        ExpFloat("DCD_P2_TELE", 21, edigits=2),
        ExpFloat("DCD_P3_TELE", 21, edigits=2),
        ExpFloat("AD_A1_TELE", 21, edigits=2),
        ExpFloat("AD_A2_TELE", 21, edigits=2),
        ExpFloat("RADIUS_OF_VALIDITY_TELE", 21, nonnegative, edigits=2),
    ],
)

telescope_transform = Vector([
    ExpFloat("TELE_TRANS_T0", 21, edigits=2),
    ExpFloat("TELE_TRANS_T1", 21, edigits=2),
    ExpFloat("TELE_TRANS_T2", 21, edigits=2),
    ExpFloat("TELE_TRANS_T3", 21, edigits=2),
    ExpFloat("TELE_TRANS_T4", 21, edigits=2),
    ExpFloat("TELE_TRANS_T5", 21, edigits=2),
    ExpFloat("TELE_TRANS_T6", 21, edigits=2),
    ExpFloat("TELE_TRANS_T7", 21, edigits=2),
])
    ...
    [
        ...
        SizedList(
            ...
            body=Struct(
                TelescopeOpticsTimeTransform,
                [
                    FixedFloat("TELE_TIME", 15, ndigits=9),
                    Alias("transform", telescope_transform),
                    SizedList(
                        name="varying_io_m",
                        count=lambda ctx: ctx["N_VARYING_IO"],
                        body=ExpFloat("TIME_VARYING_IO_M", 21, edigits=2),
                    ),
                ],
            ),
        ),
    ...
    [
        SizedList(
            ...
            body=Struct(
                FrameFieldAngleSetDirect,
                [
                    FixedFloat("FL_CAL", 11, ndigits=8),
                    FixedFloat("NUM_FIR_LINE", 12, ndigits=5, sign=True),
                    FixedFloat("DELTA_LINE", 11, ndigits=5),
                    Computed(
                        Int("NUM_FA_BLOCKS_LINE", 3, positive),
                        lambda ctx: len(ctx["blocks"]),
                    ),
                    FixedFloat("NUM_FIR_SAMP", 12, ndigits=5, sign=True),
                    FixedFloat("DELTA_SAMP", 11, ndigits=5),
                    Computed(
    ...
    [
        ...
        SizedList(
            ...
            body=Struct(
                FrameFieldAngleSetCalibration,
                [
                    FixedFloat("FL_CAL_IOP", 11, ndigits=8),
                    ExpFloat("PPO_XO", 21, edigits=2),
                    ExpFloat("PPO_YO", 21, edigits=2),
                    ExpFloat("RLD_KO", 21, edigits=2),
                    ExpFloat("RLD_K1", 21, edigits=2),
                    ExpFloat("RLD_K2", 21, edigits=2),
                    ExpFloat("RLD_K3", 21, edigits=2),
                    ExpFloat("DCD_P1", 21, edigits=2),
                    ExpFloat("DCD_P2", 21, edigits=2),
                    ExpFloat("DCD_P3", 21, edigits=2),
                    ExpFloat("AD_A1", 21, edigits=2),
                    ExpFloat("AD_A2", 21, edigits=2),
                    ExpFloat("RADIUS_OF_VALIDITY", 21, edigits=2),
                ],
            ),
        ),
    ],
...
scanner_alignment = Struct(
    ScannerAlignment,
    [
        FixedFloat("SMPL_NUM_FIRST", 12, ndigits=5, sign=True),
        FixedFloat("DELTA_SMPL_PAIRS", 11, ndigits=5),
        PrefixedList(
            name="fa_pairs",
            ...
            body=Struct(
                FieldAlignmentPair,
                [
                    FixedFloat("START_FALIGN_X", 11, ndigits=7, sign=True),
                    FixedFloat("START_FALIGN_Y", 11, ndigits=7, sign=True),
                    FixedFloat("END_FALIGN_X", 11, ndigits=7, sign=True),
                    FixedFloat("END_FALIGN_Y", 11, ndigits=7, sign=True),
                ],
            ),
        ),
    ],
...
cssfab = Segment(
    ...
    data=[
        ...
        FixedFloat("BAND_WAVELENGTH", 11, ndigits=8),
        PrefixedList(
            name="bands",
        ...
        SizedList(
            ...
            body=Struct(
                FocalLengthPoint,
                [
                    FixedFloat("FOC_LENGTH_TIME", 15, ndigits=9),
                    FixedFloat("FOC_LENGTH", 11, ndigits=8),
                ],
            ),
        ),
        Vector(
            ...
            rules=[
                FixedFloat("PPOFF_X", 10, ndigits=6, sign=True),
                FixedFloat("PPOFF_Y", 10, ndigits=6, sign=True),
                FixedFloat("PPOFF_Z", 10, ndigits=6, sign=True),
            ],
        ),
        Vector(
            name="angle_offset",
            rules=[
                FixedFloat("ANGOFF_X", 10, ndigits=7, sign=True),
                FixedFloat("ANGOFF_Y", 10, ndigits=7, sign=True),
                FixedFloat("ANGOFF_Z", 10, ndigits=7, sign=True),
            ],
        ),
        Switch(
            name="alignment",
