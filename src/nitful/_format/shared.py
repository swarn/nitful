...
eci_spec = Struct(
    ...
    [
        ...
        FixedFloat("PK1_POLE", 10, in_range(0.0, 500.0), sign=True, ndigits=8),
        FixedFloat("PK2_POLE", 10, in_range(0.0, 500.0), sign=True, ndigits=8),
        ...
        FixedFloat("PN1_UT", 10, in_range(0.0, 500.0), sign=True, ndigits=6),
        FixedFloat("PN2_UT", 10, in_range(0.0, 500.0), sign=True, ndigits=6),
        FixedFloat("PN3_UT", 10, in_range(0.0, 500.0), sign=True, ndigits=6),
        FixedFloat("PN4_UT", 10, in_range(0.0, 500.0), sign=True, ndigits=6),
    ],
)
